        ...
        try:
            if can_start:
                if not first_loop_done:
                    with open("Libraries/Move.json", "r", encoding='utf-8') as f:
                        Move = json.load(f)
                ...
                traction = 0
                direction = 0
                with open("Libraries/CAM.json", "r", encoding='utf-8') as f:
                    CAM = json.load(f)
                    print(CAM)
                ...
                with open("Libraries/tcs_color_detection.json", "r", encoding='utf-8') as f:
                    tcs = json.load(f)
                    print(tcs)
