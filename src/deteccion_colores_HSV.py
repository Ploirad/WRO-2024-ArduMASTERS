...
for frame in camera.capture_continuous(rawCapture, format="bgr", use_video_port=True):
    image = frame.array
    f, mask1, cx1, cy1 = testColor(image, bajoR, altoR, (355, 83, 93))
    f, mask2, cx2, cy2 = testColor(image, bajoG, altoG, (111, 79, 83))
    f, mask3, cx3, cy3 = testColor(image, bajoM, altoM, (300, 100, 100))
